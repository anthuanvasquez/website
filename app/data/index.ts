export const navbarData = {
  homeTitle: 'Anthuan Vasquez',
};

export const footerData = {
  author: 'Anthuan Vasquez',
  aboutAuthor:
    'Hi! I am Anthuan, a Tech enthusiast, problem solver and software engineer. Currently working at FieldNation LLC.',
  authorInterest:
  ...
  aboutTheSite:
    "This is a personal blog site built with Nuxt4, TailwindCSS, NuxtContent, Nuxt Icon. Currently it's deployed in Vercel.",
};
