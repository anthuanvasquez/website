...
<template>
  ...
  >
    <div class="mx-auto max-w-7xl">
      ...
      <nav
        class="no-scrollbar flex w-full max-w-xl mx-auto mt-2 items-center justify-start overflow-x-auto rounded-full bg-[var(--surface-elevated)]/80 px-6 py-2.5 shadow-lg ring-1 ring-white/5 backdrop-blur-md md:w-auto md:justify-center lg:gap-x-8"
